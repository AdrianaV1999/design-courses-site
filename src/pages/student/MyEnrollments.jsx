...
const MyEnrollments = () => {
  ...
  return (
    <>
      <div className="px-8 md:px-20 lg:px-36 pt-10 md:pt-20 pb-10 md:pb-20">
              ...
              <tr key={index} className="border border-gray-500/20">
                ...
                <td className="px-4 py-3 max-sm:text-right">
                  <button
                    ...
                    className="px-4 sm:px-5 py-1.5 sm:py-2 bg-purple-800 max-sm:text-xs text-white rounded-full cursor-pointer"
                  >
                    {progressArray[index] &&
