      ...
      <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
        ...
        >
              ...
              >
                ...
                {!chapter.collapsed && (
                  <div className="p-4">
                    ...
                    <div
                      className="inline-flex bg-purple-100 p-2 rounded cursor-pointer mt-2"
          ...
          {showPopup && (
            ...
            >
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button
                  type="button"
                  className="w-full bg-purple-900 text-white px-4 py-2 rounded"
                  onClick={addLecture}
                >
                  Add
                </button>
          ...
          <div>
            <button
              type="submit"
              className=" bg-purple-900 text-white w-max py-2.5 px-9 rounded-3xl my-4"
            >
              ADD
            </button>
          </div>
